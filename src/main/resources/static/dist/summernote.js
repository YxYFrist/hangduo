  ...
  */
  ...
  var LinkDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = '<div id="abcdefgh" class="form-group">' +
					'<form action="abc.html" method="post">'+
                   '<label>请选择省份</label>' +
				   '<select id="sheng" class="note-link-text form-control">'+
				   '</select>'+
				   '<br/>'+
				   '<label>请选择市区</label>'+
				   '<select id="shi" class="note-link-text form-control"></select>'+
				   '<button style="background-color:rgb(111,157,196);padding:8px 40px;border:0px;border-radius:5px;color:white;font-family:微软雅黑;font-size:15px;position:absolute;bottom:5px;right:20px;">保存</button>'
				   '</form>'+
                 '</div>';
      var footer = '<button href="#" class="btn btn-primary note-link-btn disabled" disabled style="display:none;"></button>';
